...
```{r}
data_wide <- read.table("~/Documents/Data Mining Edu/class7-master/instructor_activity_wide.csv", sep = ",", header = TRUE)
...
student_data <- read.table("~/Documents/Data Mining Edu/class7-master/student_activity.csv", sep = ",", header = TRUE)
...
names(merge) <- c("week", "instructor_active_avg", "motivation_avg")

cor.test(merge$motivation_avg, merge$instructor_active_avg)
